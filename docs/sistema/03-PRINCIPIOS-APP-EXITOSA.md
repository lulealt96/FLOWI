...
**Patrón recomendado — Onboarding Integrado:**
...
**Máximo 3 pasos de onboarding. Ideal: 2.**
...
- Fondo con blur/overlay oscuro (backdrop-blur + bg-black/50)
...
- Título principal: Grande y bold (text-2xl / text-3xl font-bold)
- Subtítulo/descripción: Más pequeño y color más suave (text-sm text-gray-500)
- Contenido: Tamaño legible estándar (text-base)
- Acciones: Botones con contraste claro entre primario y secundario
- Texto auxiliar: Pequeño y discreto (text-xs text-gray-400)
...
**Patrones de loading para IA:**
- Si tarda <2s: Spinner simple
- Si tarda 2-5s: Skeleton loader que simula el formato del resultado
- Si tarda >5s: Barra de progreso o mensajes rotativos ("Analizando tu texto..." → "Generando propuesta..." → "Casi listo...")
...
**Sistema de color mínimo (4 colores):**
1. **Primario**: El color de la marca. Botones principales, links, elementos activos.
2. **Fondo**: El color base. Claro para apps de productividad, oscuro para apps de consumo/entretenimiento.
3. **Texto**: Alto contraste con el fondo. Nunca gris claro sobre blanco.
4. **Acento/Estado**: Para éxito (verde), error (rojo), warning (amarillo), info (azul).
...
- Fondos de secciones alternando entre neutros (white / gray-50 / gray-100) para crear ritmo
...
**Patrones de color por tipo de app:**
- Productividad/Trabajo: Fondos claros, azules/verdes como primario
- Creatividad/Diseño: Fondos oscuros, acentos vibrantes
- Finanzas: Fondos claros, verde/azul oscuro, sensación de confianza
- Salud/Bienestar: Tonos suaves, verdes/teal, sensación de calma
- Educación: Colores amigables, no corporativos, sensación accesible
...
## CHECKLIST DE CALIDAD UX (Aplicar a Cada Pantalla)
...
[ ] ¿Funciona en mobile sin scroll horizontal?
...
[ ] ¿Se puede navegar con Tab y Enter (accesibilidad básica)?
```
...
## CHECKLIST DE CALIDAD UX ACTUALIZADO (Aplicar a Cada Pantalla)
