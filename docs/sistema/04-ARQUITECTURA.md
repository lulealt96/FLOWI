...
[Landing Page] — Ve qué hace la app + demo visual
    │
    ▼
[CTA: "Probar gratis"] — Click sin registro
    │
    ▼
[Pantalla Core] — Hace su PRIMERA acción (con datos de ejemplo pre-cargados)
    │
    ▼
[Resultado WOW] — Ve el resultado inmediato
    │
    ▼
[Modal: "Guarda tu resultado — Crea tu cuenta gratis"]
    │
    ▼
[Registro rápido] — Email + contraseña (o Google OAuth)
    │
    ▼
[Onboarding mínimo] — 1-2 preguntas de personalización
    │
    ▼
[App Principal] — Ya está dentro, con su primer resultado guardado
```
...
Diseñar el esquema ANTES de escribir código, no al momento del deploy. Para cada entidad de la app:
