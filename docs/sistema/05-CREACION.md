...
### Paso 4: Construir la Pantalla Core

Esta es la pantalla más importante. Donde ocurre la magia. Sigue este patrón:
...
```typescript
// lib/ai.ts — Ejemplo de estructura
...
- [ ] La app funciona de principio a fin sin errores
- [ ] El flujo de primer uso está implementado
- [ ] La pantalla core genera resultados con IA
