...
- Vercel Hobby (gratis): técnicamente sus términos PROHÍBEN el uso comercial, y en teoría
  ...
  límites gratis (100GB de ancho de banda/mes, 100K invocaciones de función), rara vez lo
  aplican para apps pequeñas — por eso mucha gente vende apps en Hobby sin que les cobren.
...
Vercel Hobby  : 100 GB bandwidth (tope duro) · 1M invocaciones · funciones ~300s (Fluid compute) ·
                cron mínimo 1×/día.
