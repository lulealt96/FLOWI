...
[ ] Inputs a la IA considerados para prompt-injection (no ejecutar acciones según texto del usuario)
...
[ ] Webhooks de pago verifican firma en TIEMPO CONSTANTE (timingSafeEqual), sobre el RAW body, con idempotencia (processed_events) y máquina de estados — ver 18
